...
class TestMultislicePtychoLSQML(tutils.BaseTester):
    ...
    @tutils.BaseTester.wrap_recon_tester(name='test_multislice_ptycho_rpie_regularized')
    def test_multislice_ptycho_rpie_regularized(self):
        ...
        options.object_options.multislice_regularization.weight = 0.05
    ...
    @tutils.BaseTester.wrap_recon_tester(name='test_multislice_ptycho_rpie_regularized_poscorr')
    def test_multislice_ptycho_rpie_regularized_poscorr(self):
        self.setup_ptychi(cpu_only=False)
...
if __name__ == '__main__':
    ...
    tester.test_multislice_ptycho_rpie_regularized()
    tester.test_multislice_ptycho_rpie_regularized_poscorr()
